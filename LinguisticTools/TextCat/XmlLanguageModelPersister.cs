namespace LinguisticTools.TextCat
{
    ...
    public class XmlLanguageModelPersister<T>
    {
        ...
        public LanguageModel<T> Load(Stream sourceStream)
        {
            ...
            var result = this.Load(xDocument.Root);
            return result;
        }
        ...
        public LanguageModel<T> Load(XElement xLanguageModel)
        {
            ...
            {
                features.AddEvent(this._deserializeFeature(xElement.Attribute(TextAttribute).Value), long.Parse(xElement.Attribute(CountAttribute).Value));
            }
        ...
        {
            var document = new XDocument(this.ToXml(languageModel));
                                          ...
                                          languageModel.Features.DistinctRepresentedEvents
                                              .Select(
                                                  ...
                                                  new XElement(NGramElement,
                                                               new XAttribute(TextAttribute, this._serializeFeature(event_)),

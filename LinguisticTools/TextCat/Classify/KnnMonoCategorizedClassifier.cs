namespace LinguisticTools.TextCat.Classify
{
    ...
    public class KnnMonoCategorizedClassifier<TItem, TCategory> : ICategorizedClassifier<TItem, TCategory>
    {
        ...
        public KnnMonoCategorizedClassifier(IDistanceCalculator<TItem> distanceCalculator, IDictionary<TItem, TCategory> knownInstances)
        {
            ...
            this._knownInstances = new Dictionary<TItem, TCategory>(knownInstances);
            if (this._knownInstances.Count == 0)
        ...
        public IEnumerable<Tuple<TCategory, double>> Classify(TItem item)
        {
            ...
            foreach (var knownInstance in this._knownInstances)
            {
                ...
                distanceSumAndCount.DistanceSum += this._distanceCalculator.CalculateDistance(item, knownInstance.Key);
